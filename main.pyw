...
def main(fr1,fr2,fr3,it_no,it_cl):
    ...
    def onSave(svtype,lb0,lb1,lb2,lb3,lb4,lb5,lb6):
        ...
        if svtype=="saveas":
            ...
            if path:
                ...
                messagebox.showinfo("File saved","File saved at: %s.xlsx"%(path))
    ...
    def OnMouseWheel(event):
        ...
        lb69.yview("scroll",-event.delta,"units")
        return "break"
    def onSearch(choice,order,query,lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6):
        lb0.delete(0,END)
        lb69.delete(0,END)
        lb1.delete(0,END)
        lb2.delete(0,END)
    ...
    def onDate(event,choice,query,lb0,lb1,lb2,lb3,lb4,lb5,lb6):
        if event=="Select all":
            onSearch("Select all", "dop", query,lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6)
        elif event=="Pick a date":
            global cd
            cd = CalendarDialog(topFrame)
            if str(cd.result) !='None':
                dateVar.set(cd.result)
                onSearch(cd.result, "dop",query,lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6)
            else:
                onSearch("Select all", "dop", query,lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6)
        elif event=="ASC" or event=="DESC":
            onSearch(event, "dop", query,lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6)
    ...
    def onDelete(item_no):
        ...
        main(menFrame,topFrame,botFrame,-1,"dummyVar")
    def onFullscreen():
        global boo
        if boo:
            boo=False
    ...
    adminMenu.add_command(label="Logout",command=lambda: login(menFrame,topFrame,botFrame))
    ...
    srcVar=StringVar()
    srcBox=Entry(topFrame,textvariable=srcVar, font=("Helvetica",14),width=20)
    srBtn=Button(topFrame,text="Search", font=("Helvetica",12), command=lambda:onSearch("Select all","item_no",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    srcBox.grid(row=1,column=1,sticky=E)
    srBtn.grid(row=1,column=2,pady=10,sticky=W)
    srcBox.bind('<Return>', lambda event: onSearch("Select all","item_no",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    ...
    itemBtn=OptionMenu(botFrame, itemVar, "Select all", *itemCho, command=lambda event: onSearch(event,"item_no",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    areaBtn=OptionMenu(botFrame, areaVar, "Select all", *areaCho, command=lambda event: onSearch(event,"area",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    typeBtn=OptionMenu(botFrame, typeVar, "Select all", *typeCho, command=lambda event: onSearch(event,"type",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    descBtn=OptionMenu(botFrame, descVar, "Select all", *descCho, command=lambda event: onSearch(event,"des",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    serlBtn=OptionMenu(botFrame, serlVar, "Select all", *serlCho, command=lambda event: onSearch(event,"sn",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    dateBtn=OptionMenu(botFrame, dateVar, "Select all", *dateCho, command=lambda event: onDate(event,"dop",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    qntyBtn=OptionMenu(botFrame, qntyVar, "Select all", *qntyCho, command=lambda event: onSearch(event,"qty",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6))
    ...
    lb69=Listbox(botFrame, height=25, width=11, yscrollcommand=VSB.set, exportselection=0, font=("Helvetica",12))
    ...
    def selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,sed):
        lb69.selection_clear(0,END)
        lb69.selection_set(sed)
        lb69.activate(sed)
        ...
        lb6.activate(sed)
    def clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6):
        lb69.selection_clear(0, END)
        lb1.selection_clear(0, END)
        lb2.selection_clear(0, END)
        lb3.selection_clear(0, END)
    ...
    lb0.bind("<Control-s>",lambda event: onSave("saveas",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb1.bind("<Control-s>",lambda event: onSave("saveas",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb2.bind("<Control-s>",lambda event: onSave("saveas",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb3.bind("<Control-s>",lambda event: onSave("saveas",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb4.bind("<Control-s>",lambda event: onSave("saveas",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb5.bind("<Control-s>",lambda event: onSave("saveas",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb6.bind("<Control-s>",lambda event: onSave("saveas",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    ...
    lb0.bind("<F12>",lambda event: onSave("autosave",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb1.bind("<F12>",lambda event: onSave("autosave",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb2.bind("<F12>",lambda event: onSave("autosave",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb3.bind("<F12>",lambda event: onSave("autosave",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb4.bind("<F12>",lambda event: onSave("autosave",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb5.bind("<F12>",lambda event: onSave("autosave",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb6.bind("<F12>",lambda event: onSave("autosave",lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb0.bind("<Escape>",lambda event: clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb1.bind("<Escape>",lambda event: clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb2.bind("<Escape>",lambda event: clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb3.bind("<Escape>",lambda event: clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb4.bind("<Escape>",lambda event: clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb5.bind("<Escape>",lambda event: clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb6.bind("<Escape>",lambda event: clearer(lb69,lb1,lb2,lb3,lb4,lb5,lb6))
    lb0.bind("<<ListboxSelect>>", lambda event: selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,lb0.curselection()))
    lb1.bind("<<ListboxSelect>>", lambda event: selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,lb1.curselection()))
    lb2.bind("<<ListboxSelect>>", lambda event: selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,lb2.curselection()))
    lb3.bind("<<ListboxSelect>>", lambda event: selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,lb3.curselection()))
    lb4.bind("<<ListboxSelect>>", lambda event: selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,lb4.curselection()))
    lb5.bind("<<ListboxSelect>>", lambda event: selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,lb5.curselection()))
    lb6.bind("<<ListboxSelect>>", lambda event: selector(lb69,lb1,lb2,lb3,lb4,lb5,lb6,lb6.curselection()))
    ...
    onSearch("Select all","item_no",srcVar.get(),lb69,lb0,lb1,lb2,lb3,lb4,lb5,lb6)
    ...
    if it_no!=-1:
        if it_cl=="item":
            ...
            lb6.focus_set()
        lb69.selection_set(it_no-1)
        lb69.activate(it_no-1)
...
def create(fr1,fr2,fr3):
    ...
    canlBtn.grid(column=1,row=7,pady=40,padx=1,sticky=E)
...
def edit(fr1,fr2,fr3,item_no,item_clicked):
    ...
    canlBtn.grid(column=1,row=8,pady=40,padx=1,sticky=E)
...
def view(fr1,fr2,fr3):
    ...
    def onSave(svtype,lb0,lb1,lb2,lb3,lb4,lb5,lb6):
        ...
        lbh=(("Type","Bantay","Calasiao","Irisan","Isabela","La Union", "Nueva Ecija", "Pampanga", "Villasis","Type Total"),)
    ...
    logo = Label(topFrame, image=photo, bg="#7a8694")
    logo.bind('<Button-1>',lambda event:main(menFrame,topFrame,botFrame,-1,"dummyObject"))
    logo.grid(row=0, column=0,pady=90)
...
def helps(fr1,fr2,fr3):
    ...
    inf3=Label(botFrame,text="[Table view]Prompts save as window",                           font=("Helvetica","12"),bd=2,relief="solid")
    inf4=Label(botFrame,text="[Table view]Quick save to \Output\ folder",                    font=("Helvetica","12"),bd=2,relief="solid")
 ...
 """
    txt2="""
                               Supervisor Engineer: Engr. Ulyses V. Agtarap
                                   Project manager: John C. Carlos Buccat
                            Database administrator: Terry Carl G. Cuesta
